...
<section id="home" class="home-cover">
    ...
    <div class="cover_slider owl-carousel owl-theme" >
        ...
        <div class="cover_item" style="background: url('images/n.jpg'); background-size: cover;">
            <div class="slider_content">
                <div class="slider-content-inner">
                    <div class="container">
...
The Golf Cup, sees keen involvement from state government ministers from across the North East, with the first day of the tournament dedicated to the local golfers and government officials. The second day sees the leading figures of the industry competing against each other and displaying exemplary sportsmanship. The event concludes with a gala ceremony concluding in the prize- distribution ceremony. The event is also embellished with a cultural show, with ethnic dance performances from across the north east, showcasing national multiculturalism and pluralism.
 ...
 <article>
                    <div class="fb-page" data-href="https://www.facebook.com/golfcup.iimshillong/" data-tabs="timeline" data-width="400" data-height="400"
                        ...
                        <blockquote cite="https://www.facebook.com/golfcup.iimshillong/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/golfcup.iimshillong/">Golf Cup-Season 11</a></blockquote>
                    </div>
                    <!-- <footer>
...
<section class=" pb100">
    <div class="container">
        ...
        <div class="row justify-content-center ">
			...
			<h5 class="heading_Text"> International Participantion</h5>
                <p class="boundary_Text" style="text-align:justify">
				
                   Golf Cup Season 11 is going international with Golfers expected from countries such as Singapore, Thailand, Myanmar and Bangladesh.
                            Golf Cup is in line with the government's a "Act East" policy by being a platform to increase tourism in the North East by giving exposure to international Golfers from South and East Asia.
             </p>
            </div>
			 <div class="col-12 col-md-4 ">
...
the Golfing sprit in Meghalaya.</p>
			 ...
			 <div class="col-12 col-md-4 ">
			 <h5 class="heading_Text" > Expansion of Nurturing Minds</h5>
                <p class="boundary_Text" style="text-align:justify">
                    The initiative in memory of Dr. A.P.J. Abdul Kalam will be
expanded by the students of IIM Shillong to include
dance classes and golf sessions for the children from the 
underprivileged sections of the society. This initiative will
be carried out throughout the year on every Saturday. The school students will also be given a chance to play in the golf course.</p>
            </div>
...
<!--brands section -->
<section id="sponsors" class="bg-gray pt100 pb100">
    <div class="container">
        ...
        <div class="brand_carousel owl-carousel">
            ...
            <div class="brand_item text-center">
                <img src="assets/img/brands/gs.png" alt="brand" vspace="10">
            </div>

             <div class="justify-content-center align-items-center">
                <img src="assets/img/brands/sbi.png" align= "middle" alt="brand">
            </div>
			 <div class="brand_item text-center">
                <img src="assets/img/brands/io.png" alt="brand">
            </div>
            <div class="justify-content-center align-items-center">
                <img src="assets/img/brands/hsbc.png" alt="brand" vspace="30">
            </div>
			...
			<div class="brand_item text-center">
                <img src="assets/img/brands/uco.png" alt="brand">
            </div>
